...
/*
 * Copyright: © 2012-2015 Sierra Wireless, Inc. all rights reserved
 */
...
{
    WORD contentLen;
    BYTE content[MAX_DESCRIPTION_LENGTH+1];
} readResult;
 ...
 *
 *  \param  pUIMPowerUpReq[IN]
 *          - See \ref UIMPowerUpReq for more information.
 *
 *  \return eQCWWAN_ERR_NONE on success, eQCWWAN_xxx error value otherwise
 *
 *  \sa     See qmerrno.h for eQCWWAN_xxx error values
 ...
 *  with a Get Slots Status API.
 *
 *  \param  uimSlotStatus[MAX_SLOTS_STATUS]
 *          - Contain all slots status.
 */
 ...
 *          - Slots Status  See \ref UIMSlotsStatus for more information..
 */
 ...
 *
 *  \param  pReq[IN]
 *          - See \ref UIMSwitchSlotReq for more information.
 *
 *  \return eQCWWAN_ERR_NONE on success, eQCWWAN_xxx error value otherwise
 *
 *  \sa     See qmerrno.h for eQCWWAN_xxx error values
