...
/*
 * Copyright: © 2013-2015 Sierra Wireless, Inc. all rights reserved
 */
 ...
 *
 *  \param  qosFlow[MAX_QOS_SPEC_PER_APN]
 *          - Data statistic per QoS flow
 *          - See \ref sQosFlowStat for more information
 *          - See \ref MAX_QOS_SPEC_PER_APN for more information
 */
typedef struct
{
    ULONG    apnId;
...
/**
 * This structure contains the Extra Apn Params
 *
 *  \param  apnId
 *          - APN id
 ...
 *
 *  \param[out] pQosStat
 *              See \ref sQosStat for more information
 *
 *  \return eQCWWAN_ERR_NONE on success, eQCWWAN_xxx error value otherwise
 *
 *  \sa     See qmerrno.h for eQCWWAN_xxx error values
 ...
 *              - APN id
 *
 *  \param[out] pApnExtraParams
 *              See \ref sApnExtraParams for more information
 *
 *  \return eQCWWAN_ERR_NONE on success, eQCWWAN_xxx error value otherwise
 *
 *  \sa     See qmerrno.h for eQCWWAN_xxx error values
 *
 */
ULONG SLQSQosSwiReadApnExtraParams (
        BYTE        instance,
        ULONG       apnId,
